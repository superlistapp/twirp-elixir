defmodule Twirp.Protoc.CLI do
  ...
  def main(_) do
    ...
    response = %Google.Protobuf.Compiler.CodeGeneratorResponse{file: files, supported_features: Google.Protobuf.Compiler.CodeGeneratorResponse.Feature.value(:FEATURE_PROTO3_OPTIONAL)}
